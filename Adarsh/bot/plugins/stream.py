...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        online_link = await short_link(f"{Var.URL}{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}", user) if Var.IS_DISPLAY_DL_LINK else stream_link
